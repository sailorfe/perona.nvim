...
Perona.build = function()
	local theme = {
		...
		DiagnosticError = {fg = "#A90F30"},
		DiagnosticFloatingError = {link = "DiagnosticError"},
		DiagnosticSignError = {link = "DiagnosticError"},
		DiagnosticVirtualTextError = {link = "DiagnosticError"},
		DiagnosticHint = {fg = "#8DAFE2"},
		...
		DiagnosticUnderlineError = {fg = "#A90F30", underline = true},
		...
		DiffChange = {fg = "#281520", bg = "#DE91DA", bold = true},
		...
		["@macro"] = {link = "Macro"},
		MatchParen = {fg = "#8DAFE2", bg = "#683152", bold = true},
