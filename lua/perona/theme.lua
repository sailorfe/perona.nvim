...
local theme = lush(function(injected_functions)
	...
	return {
		...
		sym("@markup.heading.5")({ bg = kumashi.darken(60).desaturate(60), fg = kumashi, gui = "bold" }),
		sym("@markup.heading.6")({ bg = mihawk.darken(60).desaturate(60), fg = mihawk, gui = "bold" }),
		sym("@markup.heading.1.marker")({ fg = hollow, gui = "bold" }),
		sym("@markup.heading.2.marker")({ fg = kumashi, gui = "bold" }),
		sym("@markup.heading.3.marker")({ fg = zombie, gui = "bold" }),
		sym("@markup.heading.4.marker")({ fg = garden, gui = "bold" }),
		sym("@markup.heading.5.marker")({ fg = sangria, gui = "bold" }),
		sym("@markup.heading.6.marker")({ fg = mihawk, gui = "bold" }),
