...
local theme = lush(function(injected_functions)
	...
	return {
		...
		sym("@markup.heading.1")({ bg = gpp.hollow.darken(60).desaturate(60), fg = gpp.hollow, gui = "bold" }),
		sym("@markup.heading.2")({ bg = gpp.sangria.darken(60).desaturate(60), fg = gpp.sangria, gui = "bold" }),
		sym("@markup.heading.3")({ bg = gpp.garden.darken(60).desaturate(60), fg = gpp.garden, gui = "bold" }),
		sym("@markup.heading.4")({ bg = gpp.zombie.darken(60).desaturate(60), fg = gpp.zombie, gui = "bold" }),
		sym("@markup.heading.5")({ bg = gpp.kumashi.darken(60).desaturate(60), fg = gpp.kumashi, gui = "bold" }),
		sym("@markup.heading.6")({ bg = gpp.mihawk.darken(60).desaturate(60), fg = gpp.mihawk, gui = "bold" }),
